...
<img src="JVM学习.assets/20200608150422.png" alt="img" style="zoom:50%;" />

## 二、内存结构

### **整体架构**

<img src="JVM学习.assets/20200608150440.png" alt="img" style="zoom: 50%;" />
...
<img src="JVM学习.assets/20200608150534.png" alt="img" style="zoom:50%;" />
...
<img src="JVM学习.assets/20200608150547.png" alt="img" style="zoom: 67%;" />
...
- 然后能在控制台看到反编译以后类的信息了
  ...
  - 类的基本信息
    ...
    <img src="JVM学习.assets/20200608150618.png" alt="img" style="zoom: 67%;" />

  - 常量池

    <img src="JVM学习.assets/20200608150630.png" alt="img" style="zoom:67%;" />

  

  <img src="JVM学习.assets/20200608150641.png" alt="img" style="zoom:67%;" />

  - 虚拟机中执行编译的方法（框内的是真正编译执行的内容，**#号的内容需要在常量池中查找**）

    <img src="JVM学习.assets/20200608150653.png" alt="img" style="zoom:67%;" />
...
<img src="JVM学习.assets/20200608150715.png" alt="img" style="zoom: 50%;" />

**使用了DirectBuffer**

<img src="JVM学习.assets/20200608150736.png" alt="img" style="zoom: 50%;" />
...
<img src="JVM学习.assets/20200608150750.png" alt="img" style="zoom:67%;" />
...
<img src="https://nyimapicture.oss-cn-beijing.aliyuncs.com/img/20200608150800.png" alt="img" style="zoom: 50%;" />
...
<img src="JVM学习.assets/20200608150813.png" alt="img" style="zoom: 50%;" />
...
<img src="JVM学习.assets/20200608150827.png" alt="img" style="zoom:50%;" />

标记-整理 会将不被GC Root引用的对象回收，清楚其占用的内存空间。然后整理剩余的对象，可以有效避免因内存碎片而导致的问题，但是因为整体需要消耗一定的时间，所以效率较低

#### 复制

![img](JVM学习.assets/20200608150842.png)

![img](JVM学习.assets/20200608150856.png)

![img](JVM学习.assets/20200608150907.png)

![img](JVM学习.assets/20200608150919.png)

将内存分为等大小的两个区域，FROM和TO（TO中为空）。先将被GC Root引用的对象从FROM放入TO中，再回收不被GC Root引用的对象。然后交换FROM和TO。这样也可以避免内存碎片的问题，但是会占用双倍的内存空间。

### 3、分代回收

![img](JVM学习.assets/20200608150931.png)

#### 回收流程

新创建的对象都被放在了**新生代的伊甸园**中

![img](JVM学习.assets/20200608150939.png)

当伊甸园中的内存不足时，就会进行一次垃圾回收，这时的回收叫做 **Minor GC**

Minor GC 会将**伊甸园和幸存区FROM**存活的对象**先**复制到 **幸存区 TO**中， 并让其**寿命加1**，再**交换两个幸存区**

![img](JVM学习.assets/20200608150946.png)

![img](JVM学习.assets/20200608150955.png)

![img](JVM学习.assets/20200608151002.png)
...
![img](JVM学习.assets/20200608151010.png)

如果幸存区中的对象的**寿命超过某个阈值**（最大为15，4bit），就会被**放入老年代**中

![img](JVM学习.assets/20200608151018.png)
...
![img](JVM学习.assets/20200608151027.png)
...
[<img src="JVM学习.assets/20200608151039.png" alt="img" style="zoom:50%;" />](https://nyimapicture.oss-cn-beijing.aliyuncs.com/img/20200608151039.png)
...
<img src="JVM学习.assets/20200608151052.png" alt="img" style="zoom:50%;" />](https://nyimap
...
<img src="JVM学习.assets/20200909201212.png" alt="img" style="zoom: 80%;" />
...
<img src="JVM学习.assets/20200608151100.png" alt="img" style="zoom: 67%;" />

##### G1垃圾回收阶段

<img src="https://nyimapicture.oss-cn-beijing.aliyuncs.com/img/20200608151109.png" alt="img" style="zoom: 33%;" />
...
<img src="JVM学习.assets/20200608151119.png" alt="img" style="zoom: 50%;" />

<img src="JVM学习.assets/20200608151129.png" alt="img" style="zoom:50%;" />

<img src="JVM学习.assets/20200608151140.png" alt="img" style="zoom:50%;" />
...
<img src="JVM学习.assets/20200608151150.png" alt="img" style="zoom:50%;" />
...
<img src="JVM学习.assets/20200608151201.png" alt="img" style="zoom:50%;" />
...
<img src="https://nyimapicture.oss-cn-beijing.aliyuncs.com/img/20200608151211.png" alt="img" style="zoom:50%;" />
...
<img src="JVM学习.assets/20200608151222.png" alt="img" style="zoom:67%;" />
...
<img src="JVM学习.assets/20200608151229.png" alt="img" style="zoom:50%;" />
...
<img src="JVM学习.assets/20200608151239.png" alt="img" style="zoom:50%;" />
...
<img src="JVM学习.assets/20200608151249.png" alt="img" style="zoom:50%;" />
...
![img](JVM学习.assets/20200608151300.png)
...
![img](JVM学习.assets/20200910155135.png)
...
![img](JVM学习.assets/20200608151317.png)

（stack=2，locals=4） 对应操作数栈有2个空间（每个空间4个字节），局部变量表中有4个槽位

![img](JVM学习.assets/20200608151325.png)
...
![img](JVM学习.assets/20200608151336.png)
...
![img](JVM学习.assets/20200608151346.png)

![img](https://nyimapicture.oss-cn-beijing.aliyuncs.com/img/20200608151412.png)
...
![img](JVM学习.assets/20200608151421.png)

**istore 2**

将操作数栈中的元素弹出，放到局部变量表的2号位置

![img](JVM学习.assets/20200608151432.png)

![img](JVM学习.assets/20200608151441.png)
...
![img](JVM学习.assets/20200608151450.png)

![img](JVM学习.assets/20200608151459.png)

**iadd**

将操作数栈中的两个元素**弹出栈**并相加，结果在压入操作数栈中

![img](JVM学习.assets/20200608151508.png)

![img](JVM学习.assets/20200608151523.png)

**istore 3**

将操作数栈中的元素弹出，放入局部变量表的3号位置

![img](JVM学习.assets/20200608151547.png)

![img](JVM学习.assets/20200608151555.png)
...
![img](JVM学习.assets/20200608151605.png)

![img](JVM学习.assets/20200608151613.png)

**iload 3**

将局部变量表中3号位置的元素压入操作数栈中

![img](JVM学习.assets/20200608151624.png)
...
![img](JVM学习.assets/20200608151632.png)

执行完毕，弹出栈帧

清除 main 操作数栈内容

![img](JVM学习.assets/20200608151640.png)
...
![img](JVM学习.assets/20200611205050.png)
...
![img](JVM学习.assets/20200611221703.png)

- 定位需要的进程

![img](JVM学习.assets/20200611221857.png)

![img](JVM学习.assets/20200611222029.png)
...
![img](JVM学习.assets/20200611223153.png)

查看类C的常量池，可以看到类D**未被解析**，只是存在于常量池中的符号

![img](JVM学习.assets/20200611230658.png)

- 解析以后，会将常量池中的符号引用解析为直接引用

  - 可以看到，此时已加载并解析了类C和类D

  ![img](JVM学习.assets/20200611223441.png)](https://nyimapict

![img](JVM学习.assets/20200613104723.png)
...
![img](JVM学习.assets/20201118204542.png)
